...
2. Buscar en `${CLAUDE_PLUGIN_ROOT}/skills/plantillas-industria-mx/references/templates/` si hay un template que coincida
...
Los templates están en `${CLAUDE_PLUGIN_ROOT}/skills/plantillas-industria-mx/references/templates/`. Cada template incluye:
