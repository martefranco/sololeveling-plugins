...
5. Si hay ontología en `data/ontologia/`, leer `data/ontologia/indice.md` para tener contexto del sector.
...
8. Al terminar la recopilación, SEPARAR la información en dos documentos:
   - **Perfil Core** (7 secciones genéricas del rol) → guardar en `data/perfiles/SS-AA-PP-slug.md`
   - **Variación** (6 secciones contextuales) → guardar en `data/perfiles/variaciones/SS-AA-PP-VV-slug--contexto.md`
...
11. Si se detectaron datos nuevos durante la conversación, agregar a `data/ontologia/` siguiendo las reglas de `${CLAUDE_PLUGIN_ROOT}/skills/enriquecedor-ontologia/SKILL.md`.
