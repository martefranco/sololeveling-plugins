...
2. Si el usuario proporcionó argumento, buscar primero en `data/perfiles/variaciones/` y luego en `data/perfiles/`.
3. Si no proporcionó argumento, listar variaciones y perfiles disponibles y pedir que elija. Recomendar usar una variación si existe.
...
11. Guardar cada oferta con nomenclatura correcta en `data/perfiles/ofertas/`.
