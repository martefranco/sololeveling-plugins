...
talent-mx3 uses `~~git` for sincronizar la ontología (`data/`) con un repositorio remoto. Esto permite que el conocimiento persista entre sesiones y se comparta entre usuarios.
